...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(bombFinance.BUL, bombFinance.contracts.xBOMB.address);

  const tokenBalance = useTokenBalance(bombFinance.BUL);
  ...
  const stakedTokenPriceInDollars = Number(useStakedTokenPriceInDollars('BUL', bombFinance.BUL)) * xbombRate;
